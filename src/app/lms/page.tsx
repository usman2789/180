    ...
    <div className="flex h-screen">
      ...
      <div className="flex flex-col flex-1">
        ...
        {/* Responsive Gradient Title */}
          <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold bg-gradient-to-r from-purple-500 via-indigo-600 to-purple-700 bg-clip-text text-transparent mt-1 sm:mt-4">
          ...
          <Link href="/test">
            <button className="mt-3 sm:mt-4 px-4 py-2 text-sm sm:text-lg font-semibold text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 transition-all">
              Start Your Test
            </button>
          </Link>
